...
public class PassordHash {
	...
	/**
	 * @param hashAlgorithm (e.g. use PasswordHash.SHA1 to specify the hash
	 *                      algorithm)
	 */
	public PassordHash(String hashAlgorithm) {
	...
	/**
	 * Medium password security - strong against brute force, dictionary, and
	 * rainbow attacks
	 * 
	 * @param password
	 * @param salt     Adding salt disallows 2 passwords to be the same and
	 *                 increases weak password's security (length and randomness)
	 * @throws NoSuchAlgorithmException
	 */
	...
	/**
	 * Advanced password security - strong against brute force, dictionary, and
	 * rainbow attacks We use the Password-Based Key Derivation Function (PBKDF)
	 * specially designed to slow down hash computation without destroying
	 * usability. This is used to harden the password hashing algorithm - iteration
	 * slows down the hashing computation steps and salt disallows 2 passwords to be
	 * the same and increases weak password's security (length and randomness) Make
	 * sure the salt and the hashed password are stored in a persistent storage for
	 * each user
	 * 
	 * @param password
	 * @param salt
	 * @param keylength in bits (e.g. 128, 256, 512)
	 * @param iteration number of iteration (int) to slow down CPU computations of
	 *                  the hash
	 * @throws NoSuchAlgorithmException
	 * @throws InvalidKeySpecException
	 */
	public void generateHashWithSaltAndIteration(final String password, byte[] salt, int keylength, int iteration)
	 ...
	 * @return true or false value indicating that newly hashed password matches the
	 *         stored hashed value
	 * @throws NoSuchAlgorithmException
	 */
	public boolean validatePasswordWithoutSalt(final String password, final String hashedPassword)
			throws NoSuchAlgorithmException {
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	public boolean validatePasswordWithSaltAndIteration(final String password, final String salt,
			final String hashedPassword, int keylength, int iteration)
			throws NoSuchAlgorithmException, InvalidKeySpecException {
